...
from .mr2_utils import MR2_URDF,set_mr2_group_conf
...
def parse_robot(robot_json):
    ...
    elif robot_json['name'] == 'mr2':
        with HideOutput():
            robot_id = load_model(MR2_URDF, fixed_base=True)
        set_mr2_group_conf(robot_id, 'base',  base_values_from_pose(pose))
    else:
        # TODO: set the z?
